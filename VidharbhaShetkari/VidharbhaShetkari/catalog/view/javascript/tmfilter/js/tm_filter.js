...
parse_url: function(str, component) {
	...
	_ajaxUrl: function( url ) {
		var parts = url.split('http://livedemo00.template-help.com/');
		...
		url = parts.join('http://livedemo00.template-help.com/');
...
__initLoader: function() {
	...
	.html( '<img src="catalog/view/javascript/tmfilter/css/images/ajax-loader.gif" alt="" />' )
	.hide();
},
		...
		'success'	: function( response ) {
			...
			if( response ) {
				...
				self.reload();
					...
					// if(!$('.mfilter-option').hasClass('mfilter-input-active')) {
					// 	$(this).find('.mfilter-counter').removeClass('mfilter-close');
					// } 
					// if($('.mfilter-option').hasClass('mfilter-input-active')) {
					// 	$(this).find('.mfilter-counter').addClass('mfilter-close');
					// }
					function explode(){
