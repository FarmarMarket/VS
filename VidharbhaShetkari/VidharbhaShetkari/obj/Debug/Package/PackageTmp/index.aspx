                                ...
                                <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: 0s;">
                                    <div class="owl-item active col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <div class="product-thumb transition options">
                                            <div class="image">
                                                <img src="images/banner-2-870x380.jpg" alt="" />
                                                <div class="cart-button">
                                                    <button data-product="103" class="quickview btn-icon" data-toggle="tooltip" title=""
                                                ...
                                                <div class="caption">
                                                    <div class="name">
                                                        <a href="http://livedemo00.template-help.com/opencart_63371/index.php?route=product/product&amp;product_id=103">
                                                            A Healthy Gift Idea by Broadway</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
